...
class AktivasiPerdanaPage extends StatefulWidget {
  const AktivasiPerdanaPage({super.key});

  @override
  State<AktivasiPerdanaPage> createState() => _AktivasiPerdanaPageState();
}

class _AktivasiPerdanaPageState extends State<AktivasiPerdanaPage>
          ...
          _allProducts = products
              .where(
                (p) =>
                    ...
                    p.category.toUpperCase().contains("PERDANA"),
              )
              .toList();
  ...
  void _handleProductTap(ProductPrabayar product) {
    if (_phoneController.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Masukkan nomor HP baru terlebih dahulu'),
          backgroundColor: Colors.orange,
          duration: Duration(seconds: 2),
          behavior: SnackBarBehavior.floating,
        ),
        ...
        children: [
          Container(
            ...
            child: iconUrl != null && iconUrl.isNotEmpty
                ...
                : Icon(Icons.sim_card_rounded, color: primaryColor, size: 28),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: product.iconUrl != null && product.iconUrl!.isNotEmpty
                      ...
                      : Icon(Icons.sim_card, color: primaryColor, size: 32),
                ),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Silakan pilih operator kartu perdana di atas',
