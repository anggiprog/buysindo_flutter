...
class _TVPageState extends State<TVPage> with TickerProviderStateMixin {
      ...
      if (mounted) {
        setState(() {
          _allProducts = products
              .where((p) => p.category.toUpperCase() == "TV")
              .toList();
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.live_tv, size: 48, color: primaryColor),
              ),
              ...
              Text(
                'Pilih provider untuk melihat paket TV',
          ...
          IconButton(
            ...
            onPressed: () {
              showDialog(
                context: context,
                builder: (context) => AlertDialog(
                  title: const Text('Informasi TV Berlangganan'),
                  content: const SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Cara Berlangganan TV:',
                          style: TextStyle(fontWeight: FontWeight.bold),
                        ),
                        SizedBox(height: 8),
                        Text('1. Masukkan ID Pelanggan atau Serial Number'),
                        Text('2. Pilih Provider TV'),
                        Text('3. Pilih Paket Berlangganan'),
                        Text('4. Pilih Jumlah (jika tersedia)'),
                        Text('5. Klik Beli untuk melakukan transaksi'),
                        SizedBox(height: 12),
                        Text(
                          'ID Pelanggan dapat ditemukan di kartu pelanggan atau smart card TV Anda.',
                          style: TextStyle(
                            fontSize: 12,
              ...
              child: Column(
                children: [
                  ...
                  if (_selectedBrand.isNotEmpty &&
                    ...
                    const Expanded(
                      child: Center(
                        child: Text('Pilih Provider TV terlebih dahulu'),
                      ),
                    )
                  else
                    const Expanded(
  ...
  Widget _buildEmptyState(Color primaryColor) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.tv_off, size: 100, color: Colors.grey[300]),
          const SizedBox(height: 24),
          Text(
            'Belum Ada Paket TV',
            style: TextStyle(
          ...
          const SizedBox(height: 8),
          Text(
            'Paket TV belum tersedia saat ini',
  ...
  Widget _buildIdInput(Color primaryColor) {
    return Container(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Masukkan ID pelanggan atau serial number',
                ...
                Center(
                  child: Container(
                    ...
                    child:
                        ...
                        : Icon(Icons.live_tv, color: primaryColor, size: 36),
                  ),
                ),
                const SizedBox(height: 8),
                Text(
